...
/* harmony import */ var _modules_tablet_content__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/tablet-content */ "./js/modules/tablet-content.js");
...
Object(_modules_tablet_content__WEBPACK_IMPORTED_MODULE_4__["tabletContent"])();
...
var loader = function loader() {
  ...
  if (loaderBlock) {
    ...
    var onLoaderKeydown = function onLoaderKeydown(evt) {
      if (evt.key === 'Enter') {
        evt.preventDefault();
        loaderBlock.classList.remove('loader--active');
        page.classList.add('wrapper--show');
...
/***/ "./js/modules/tablet-content.js":
/*!**************************************!*\
  !*** ./js/modules/tablet-content.js ***!
  \**************************************/
/*! exports provided: tabletContent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tabletContent", function() { return tabletContent; });
var tabletContent = function tabletContent() {
  var MAX_TABLET_WIDTH = 1023;
  var content = document.querySelector('.wrapper');
  var description = document.querySelector('.main__description');
  var headerLogo = document.querySelector('.header__logo');
  var headerLogoSvg = document.querySelector('.header__logo svg');
